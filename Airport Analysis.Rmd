...
This set of boxplots demonstrates a wide range of data for enplanements. Because there is such a variation, we will look at the boxplot where the enplanements are less than 250,000. There are `r sum(analysis.dat$enplanements < 250000, na.rm = T)/dim(analysis.dat[!is.na(analysis.dat$enplanements),])[1]` that meet this category. 
